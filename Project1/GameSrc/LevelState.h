...
//        AddGameObject(PhysicsObject());
        ...
        //(mass, shape, position, rotation, scale, inercia, entity);
        attackBoxPlayer = new PhysicsObject(0, PhysicsShape::Box, btVector3(0,5,40), btVector3(0,0,0), btVector3(5,2,5), btVector3(), new Entity(Loader::LoadModel("res/Models/cube.obj"), glm::vec3(0, 5, 40), glm::vec3(0, 0, 0), vec3(5,2,5), "", true));
