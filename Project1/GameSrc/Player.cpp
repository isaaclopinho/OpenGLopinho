...
Player::Player() : entity(Loader::LoadModel("res/Models/hans_mesh2.dae"), playerPos, playerRot, 0.05, "Walk", true)
{
	
	//initialize physics
	btCollisionShape* playerCollider = new btBoxShape(btVector3(2, 0.05, 2));
...
void Player::PlayerJump() {
	...
	playerRigidBody->applyCentralImpulse(btVector3(0, 4, 0));
